...
class ModelosControllerTest < ActionController::TestCase
  ...
  test "should create modelo" do
    assert_difference('Modelo.count') do
      post :create, modelo: { alto: @modelo.alto, ancho: @modelo.ancho, descripcion: @modelo.descripcion, fondo: @modelo.fondo, nombre: @modelo.nombre }
    end
  ...
  test "should update modelo" do
    patch :update, id: @modelo, modelo: { alto: @modelo.alto, ancho: @modelo.ancho, descripcion: @modelo.descripcion, fondo: @modelo.fondo, nombre: @modelo.nombre }
    assert_redirected_to modelo_path(assigns(:modelo))
  end
